        ...
        <table className="min-w-full text-xs">
          <thead className="bg-gray-100 border-b-2 border-gray-300">
            <tr>
              ...
              <th className="px-3 py-2 text-left font-semibold text-gray-700 uppercase text-[11px]">Required</th>
              <th className="px-3 py-2 text-left font-semibold text-gray-700 uppercase text-[11px]">Status</th>
              <th className="px-3 py-2 text-left font-semibold text-gray-700 uppercase text-[11px] hidden md:table-cell">Invoices</th>
