...
const adminNav: NavItem[] = [
  ...
  },
  {
    ...
    tabs: [
      ...
      { label: 'Invoice Schedules', href: '/dashboard/admin/requirements' },
      { label: 'Notifications', href: '/dashboard/admin/reference/notifications' },
    ],
  ...
  },
  {
    ...
    matchPaths: ['/dashboard/admin/support'],
  },
];
